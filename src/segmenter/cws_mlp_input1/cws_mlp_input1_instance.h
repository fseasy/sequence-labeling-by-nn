...
#include "segmenter/cws_module/structure_param_module/param_mlp_input1_all.h"
#include "segmenter/cws_module/nn_module/mlp_input1/nn_cws_mlp_input1_abstract.h"
#include "segmenter/cws_module/nn_module/mlp_input1/nn_cws_mlp_input1_all.h"
namespace slnn{
namespace segmenter{
...
using MlpInput1All = SegmenterMlpInput1Template<
    token_module::TokenSegmenterInput1All,
    structure_param_module::ParamSegmenterMlpInput1All,
    nn_module::NnSegmenterMlpInput1All>;
