...
#include "segmenter/model_handler/input2_modelhandler.h"
#include "utils/general.hpp"

using namespace std;
using namespace slnn;
namespace po = boost::program_options;
const string PROGRAM_DESCRIPTION = "CWS double_input-pretag Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2ModelHandler<CWSDoublePretagModel> model_handler;
