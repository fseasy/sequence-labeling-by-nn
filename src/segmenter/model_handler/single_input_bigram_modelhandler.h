#ifndef SLNN_SEGMENTER_CWS_SINGLE_BIGRAM_CLASSIFICATION_SINGLE_INPUT_BIGRAM_MODELHANDLER_H
#define SLNN_SEGMENTER_CWS_SINGLE_BIGRAM_CLASSIFICATION_SINGLE_INPUT_BIGRAM_MODELHANDLER_H
