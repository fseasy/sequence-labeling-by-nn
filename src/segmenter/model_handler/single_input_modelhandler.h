#ifndef SLNN_SEGMENTER_CWS_SINGLE_CLASSIFICATION_SINGLE_INPUT_MODELHANDLER_H
#define SLNN_SEGMENTER_CWS_SINGLE_CLASSIFICATION_SINGLE_INPUT_MODELHANDLER_H
