...
const string PROGRAM_DESCRIPTION = "CWS double_input-classification Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2ModelHandler<CWSDoubleClassificationModel> model_handler;
