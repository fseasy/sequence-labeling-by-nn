...
#include "cws_input1_cl_f2i_model.h"
...
static const string ProgramHeader = "CWS Input1-Classification F2I Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    CWSInput1WithFeatureModelHandler<RNNDerived, CWSInput1CLF2IModel<RNNDerived>> model_handler;
