...
#include "segmenter/cws_double_crf/cws_double_crf_model.h"
...
const string PROGRAM_DESCRIPTION = "CWS double_input-bigram-CRF Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2BigramModelHandler<CWSDoubleCRFModel> model_handler;
