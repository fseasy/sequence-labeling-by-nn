...
#include "segmenter/cws_single_classification/cws_single_classification_model.h"
...
const string PROGRAM_DESCRIPTION = "CWS single_input-bigram-classification Procedure based on DyNet Library";
