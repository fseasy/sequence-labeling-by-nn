...
#include "segmenter/cws_double_pretag/cws_double_pretag_model.h"
#include "segmenter/model_handler/input2_bigram_modelhandler.h"
#include "utils/general.hpp"

using namespace std;
using namespace slnn;
namespace po = boost::program_options;
const string PROGRAM_DESCRIPTION = "CWS double_input-bigram-pretag Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    op_des.add_options()
        ...
        ("tag_dim", po::value<unsigned>()->default_value(5), "The dimension for tag embedding .")
    ...
    Input2BigramModelHandler<CWSDoublePretagModel> model_handler;
