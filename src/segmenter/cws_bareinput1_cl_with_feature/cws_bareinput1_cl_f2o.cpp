...
#include "cws_bareinput1_cl_f2o_model.h"
...
static const string ProgramHeader = "CWS BareInput1-Classification F2O Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    dynet::initialize(argc, argv, CNNRandomSeed); 
