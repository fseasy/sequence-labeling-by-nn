...
#include "segmenter/cws_double_classification/cws_double_classification_model.h"
...
const string PROGRAM_DESCRIPTION = "CWS double_input-bigram-classification Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2BigramModelHandler<CWSDoubleClassificationModel> model_handler;
