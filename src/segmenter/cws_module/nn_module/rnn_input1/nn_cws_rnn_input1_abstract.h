#ifndef SLNN_SEGMENTER_CWS_MODULE_NN_MODULE_CWS_RNN_INPUT1_ABSTRACT_H_
#define SLNN_SEGMENTER_CWS_MODULE_NN_MODULE_CWS_RNN_INPUT1_ABSTRACT_H_
#include <functional>
...
template <typename StructureParamT>
void NnSegmenterRnnInput1Abstract::build_model_structure(const StructureParamT &param)
{
    ...
    birnn_layer.reset(new BILSTMLayer(this->get_dynet_model(), param.rnn_nr_stack_layer, param.corpus_token_embedding_dim,
...
NnSegmenterRnnInput1Abstract::build_training_graph(const AnnotatedDataProcessedT &ann_processed_data)
{
