#ifndef SLNN_SEGMENTOR_CWS_MODULE_NN_MODULE_EXP_LAYER_WINDOW_EXPR_PRO_LAYER_H_
#define SLNN_SEGMENTPR_CWS_MODULE_NN_MODULE_EXP_LAYER_WINDOW_EXPR_PRO_LAYER_H_
#include <vector>
#include <deque>
#include <memory>
#include <string>
