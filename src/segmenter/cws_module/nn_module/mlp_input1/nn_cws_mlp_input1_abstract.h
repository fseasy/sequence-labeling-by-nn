...
template <typename StructureParamT>
void NnSegmenterInput1MlpAbstract::build_model_structure(const StructureParamT &param)
{
...
NnSegmenterInput1MlpAbstract::build_training_graph(const AnnotatedDataProcessedT &ann_processed_data)
{
...
inline
std::vector<Index> 
NnSegmenterInput1MlpAbstract::predict(const UnannotatedDataProcessedT &unann_processed_data)
{
