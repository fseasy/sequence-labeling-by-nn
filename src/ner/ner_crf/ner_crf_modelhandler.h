#ifndef NER_CRF_MODELHANDLER_H_INCLUDED_
#define NER_CRF_MODELHANDLER_H_INCLUDED_
...
struct NERCRFModelHandler
{
    ...
    void train(const std::vector<IndexSeq> *p_sents,
        ...
        unsigned max_epoch, 
        const std::vector<IndexSeq> *p_de_sents, 
...
inline
std::string NERCRFModelHandler::replace_number(const std::string &str)
{
...
inline 
void NERCRFModelHandler::save_current_best_model(float F1)
{
