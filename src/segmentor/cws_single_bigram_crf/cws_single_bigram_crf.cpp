...
#include "segmentor/cws_single_crf/cws_single_crf_model.h"
...
const string PROGRAM_DESCRIPTION = "CWS single_input-bigram-CRF Procedure based on CNN Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    SingleInputBigramModelHandler<CWSSingleCRFModel> model_handler;
