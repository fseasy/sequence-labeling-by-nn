...
#include "segmentor/cws_module/cws_general_modelhandler.h"
#include "utils/general.hpp"

using namespace std;
namespace po = boost::program_options;
using namespace slnn;
using namespace slnn::segmentor;
using slnn::segmentor::mlp_input1::MlpInput1Cl;

static const string PROGRAM_HEADER = "segmentor Mlp-input1 based on CNN Library";
