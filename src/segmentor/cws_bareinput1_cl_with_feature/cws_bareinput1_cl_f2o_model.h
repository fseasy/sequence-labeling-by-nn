...
#include "segmentor/base_model/bareinput1_f2o_model.hpp"
...
template <typename RNNDerived>
void CWSBareInput1CLF2OModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    CWSBareInput1F2OModel<RNNDerived>::set_model_param(var_map);
}
