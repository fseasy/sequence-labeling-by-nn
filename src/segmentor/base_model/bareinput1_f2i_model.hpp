#ifndef SLNN_SEGMENTOR_BASE_MODEL_BAREINPUT1_F2I_MODEL_0628_HPP_
#define SLNN_SEGMENTOR_BASE_MODEL_BAREINPUT1_F2I_MODEL_0628_HPP_
...
template<typename RNNDerived>
void CWSBareInput1F2IModel<RNNDerived>::predict(cnn::ComputationGraph &cg,
                                                      const IndexSeq &input_seq,
                                                      const CWSFeatureDataSeq &cws_feature_seq,
                                                      IndexSeq &pred_seq)
{
