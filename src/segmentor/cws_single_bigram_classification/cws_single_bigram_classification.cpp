...
#include "segmentor/cws_single_classification/cws_single_classification_model.h"
#include "segmentor/model_handler/single_input_bigram_modelhandler.h"
#include "utils/general.hpp"

using namespace std;
using namespace slnn;
namespace po = boost::program_options;
const string PROGRAM_DESCRIPTION = "CWS single_input-bigram-classification Procedure based on CNN Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    SingleInputBigramModelHandler<CWSSingleClassificationModel> model_handler;
