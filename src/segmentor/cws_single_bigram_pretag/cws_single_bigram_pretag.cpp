...
#include "segmentor/cws_single_pretag/cws_single_pretag_model.h"
...
const string PROGRAM_DESCRIPTION = "CWS single_input-bigram-pretag Procedure based on CNN Library";
