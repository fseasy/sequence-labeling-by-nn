...
#include "pos_input1_classification_feature2input_layer_model.h"
...
static const string ProgramHeader = "Postagger Input1-Classification F2I Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    SingleInputWithFeatureModelHandler<RNNDerived, POSInput1ClassificationF2IModel<RNNDerived>> model_handler;
