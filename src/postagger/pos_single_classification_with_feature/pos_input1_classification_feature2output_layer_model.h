#ifndef SLNN_POSTAGGER_POS_INPUT1_CLASSIFICATION_FEATURE2OUTPUT_LAYER_MODEL_H_
#define SLNN_POSTAGGER_POS_INPUT1_CLASSIFICATION_FEATURE2OUTPUT_LAYER_MODEL_H_
...
class POSInput1ClassificationF2OModel : public Input1F2OModel<RNNDerived>
{
    friend class boost::serialization::access;
public:
   
    POSInput1ClassificationF2OModel() ;
    ~POSInput1ClassificationF2OModel();
...
template <typename RNNDerived>
POSInput1ClassificationF2OModel<RNNDerived>::POSInput1ClassificationF2OModel()
...
template <typename RNNDerived>
void POSInput1ClassificationF2OModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    POSInput1ClassificationF2OModel<RNNDerived>::Input1F2OModel::set_model_param(var_map);
}

template <typename RNNDerived>
void POSInput1ClassificationF2OModel<RNNDerived>::build_model_structure()
{
...
template <typename RNNDerived>
void POSInput1ClassificationF2OModel<RNNDerived>::print_model_info()
{
    BOOST_LOG_TRIVIAL(info) << "---------------- Input1 Classification F2O Model -----------------\n"
