#ifndef SLNN_POSTAGGER_POS_INPUT2_CLASSIFICATION_FEATURE2OUTPUT_LAYER_MODEL_H_
#define SLNN_POSTAGGER_POS_INPUT2_CLASSIFICATION_FEATURE2OUTPUT_LAYER_MODEL_H_
...
class POSInput2ClassificationF2OModel : public Input2F2OModel<RNNDerived>
{
    friend class boost::serialization::access;
public:
   
    POSInput2ClassificationF2OModel() ;
    ~POSInput2ClassificationF2OModel();
...
template <typename RNNDerived>
POSInput2ClassificationF2OModel<RNNDerived>::POSInput2ClassificationF2OModel()
...
template <typename RNNDerived>
void POSInput2ClassificationF2OModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    POSInput2ClassificationF2OModel<RNNDerived>::Input2F2OModel::set_model_param(var_map);
}
...
template <typename RNNDerived>
void POSInput2ClassificationF2OModel<RNNDerived>::print_model_info()
{
    BOOST_LOG_TRIVIAL(info) << "---------------- POS Input2 Classification F2O Model -----------------\n"
