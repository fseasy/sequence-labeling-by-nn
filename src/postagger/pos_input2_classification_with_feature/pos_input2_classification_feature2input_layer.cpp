...
#include "pos_input2_classification_feature2input_layer_model.h"
...
static const string ProgramHeader = "Postagger Input2-Classification F2I Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2WithFeatureModelHandler<RNNDerived, POSInput2ClassificationF2IModel<RNNDerived>> model_handler;
