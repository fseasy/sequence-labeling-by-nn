...
#include "pos_input2_pretag_feature2output_layer_model.h"
...
static const string ProgramHeader = "Postagger Input2-Pretag F2O Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    Input2WithFeatureModelHandler<RNNDerived, POSInput2PretagF2OModel<RNNDerived>> model_handler;
