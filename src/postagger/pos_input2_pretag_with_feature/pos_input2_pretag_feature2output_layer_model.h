#ifndef SLNN_POSTAGGER_POS_INPUT2_PRETAG_FEATURE2OUTPUT_LAYER_MODEL_H_
#define SLNN_POSTAGGER_POS_INPUT2_PRETAG_FEATURE2OUTPUT_LAYER_MODEL_H_
...
class POSInput2PretagF2OModel : public Input2F2OModel<RNNDerived>
{
    friend class boost::serialization::access;
public:
   
    POSInput2PretagF2OModel() ;
    ~POSInput2PretagF2OModel();
...
template <typename RNNDerived>
POSInput2PretagF2OModel<RNNDerived>::POSInput2PretagF2OModel()
...
template <typename RNNDerived>
void POSInput2PretagF2OModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    tag_embedding_dim = var_map["tag_embedding_dim"].as<unsigned>();
    POSInput2PretagF2OModel<RNNDerived>::Input2F2OModel::set_model_param(var_map);
}

template <typename RNNDerived>
void POSInput2PretagF2OModel<RNNDerived>::build_model_structure()
{
...
template <typename RNNDerived>
void POSInput2PretagF2OModel<RNNDerived>::print_model_info()
{
    BOOST_LOG_TRIVIAL(info) << "---------------- POS Input2 Pretag F2O Model -----------------\n"
...
template <typename RNNDerived>
template <typename Archive>
void POSInput2PretagF2OModel<RNNDerived>::serialize(Archive &ar, unsigned version)
{
