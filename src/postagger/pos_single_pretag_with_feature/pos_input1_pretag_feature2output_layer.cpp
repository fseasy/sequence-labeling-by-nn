...
#include "pos_input1_pretag_feature2output_layer_model.h"
...
static const string ProgramHeader = "Postagger Input1-Pretag F2I Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    op_des.add_options()
        ...
        ("word_embedding_dim", po::value<unsigned>()->default_value(50), "The dimension for dynamic word embedding.")
    ...
    SingleInputWithFeatureModelHandler<RNNDerived, POSInput1PretagF2OModel<RNNDerived>> model_handler;
