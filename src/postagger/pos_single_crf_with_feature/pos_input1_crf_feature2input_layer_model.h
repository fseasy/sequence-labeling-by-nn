#ifndef SLNN_POSTAGGER_POS_INPUT1_CRF_FEATURE2INPUT_LAYER_MODEL_H_
#define SLNN_POSTAGGER_POS_INPUT1_CRF_FEATURE2INPUT_LAYER_MODEL_H_
...
class POSInput1CRFF2IModel : public Input1F2IModel<RNNDerived>
{
    friend class boost::serialization::access;
public:
   
    POSInput1CRFF2IModel() ;
    ~POSInput1CRFF2IModel();
...
template <typename RNNDerived>
POSInput1CRFF2IModel<RNNDerived>::POSInput1CRFF2IModel()
...
template <typename RNNDerived>
void POSInput1CRFF2IModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    tag_embedding_dim = var_map["tag_embedding_dim"].as<unsigned>();
    POSInput1CRFF2IModel<RNNDerived>::Input1F2IModel::set_model_param(var_map);
}

template <typename RNNDerived>
void POSInput1CRFF2IModel<RNNDerived>::build_model_structure()
{
    ...
    this->output_layer = new CRFOutput(this->m, tag_embedding_dim, this->rnn_h_dim, this->rnn_h_dim, this->hidden_dim,
        this->output_dim, this->dropout_rate);
}

template <typename RNNDerived>
void POSInput1CRFF2IModel<RNNDerived>::print_model_info()
{
    BOOST_LOG_TRIVIAL(info) << "---------------- POS Input1 CRF F2I Model -----------------\n"
...
template <typename RNNDerived>
template <typename Archive>
void POSInput1CRFF2IModel<RNNDerived>::serialize(Archive &ar, unsigned version)
{
