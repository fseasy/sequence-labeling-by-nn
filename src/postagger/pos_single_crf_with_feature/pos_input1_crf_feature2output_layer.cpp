...
#include "pos_input1_crf_feature2output_layer_model.h"
...
static const string ProgramHeader = "Postagger Input1-CRF F2I Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    SingleInputWithFeatureModelHandler<RNNDerived, POSInput1CRFF2OModel<RNNDerived>> model_handler;
