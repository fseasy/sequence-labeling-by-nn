#ifndef SLNN_POSTAGGER_POS_INPUT1_CRF_FEATURE2OUTPUT_LAYER_MODEL_H_
#define SLNN_POSTAGGER_POS_INPUT1_CRF_FEATURE2OUTPUT_LAYER_MODEL_H_
...
class POSInput1CRFF2OModel : public Input1F2OModel<RNNDerived>
{
    friend class boost::serialization::access;
public:
   
    POSInput1CRFF2OModel() ;
    ~POSInput1CRFF2OModel();
...
template <typename RNNDerived>
POSInput1CRFF2OModel<RNNDerived>::POSInput1CRFF2OModel()
...
template <typename RNNDerived>
void POSInput1CRFF2OModel<RNNDerived>::set_model_param(const boost::program_options::variables_map &var_map)
{
    tag_embedding_dim = var_map["tag_embedding_dim"].as<unsigned>();
    POSInput1CRFF2OModel<RNNDerived>::Input1F2OModel::set_model_param(var_map);
}

template <typename RNNDerived>
void POSInput1CRFF2OModel<RNNDerived>::build_model_structure()
{
...
template <typename RNNDerived>
void POSInput1CRFF2OModel<RNNDerived>::print_model_info()
{
    BOOST_LOG_TRIVIAL(info) << "---------------- Input1 CRF F2O Model -----------------\n"
...
template <typename RNNDerived>
template <typename Archive>
void POSInput1CRFF2OModel<RNNDerived>::serialize(Archive &ar, unsigned version)
{
