...
constexpr size_t Input1MLPModel::PostaggerContextSize ;
...
void Input1MLPModel::set_model_param(const boost::program_options::variables_map &var_map)
{
    ...
    input_dim = word_embedding_dim + context_feature.calc_context_feature_dim(word_embedding_dim) 
        + pos_feature.get_pos_feature_dim() ;
}
