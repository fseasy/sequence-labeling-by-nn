...
public:
    ...
    void load_fixed_embedding() override;
...
{
    Word2vecEmbeddingHelper::load_fixed_embedding(is, this->fixed_word_dict, fixed_word_embeddig_dim, input_layer->fixed_lookup_param);
}
