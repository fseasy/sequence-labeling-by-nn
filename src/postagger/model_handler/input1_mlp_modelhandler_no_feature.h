#ifndef POSTAGGER_MODELHANDLER_INPUT1_MLP_MODELHANDLER_NO_FEATURE_H_
#define POSTAGGER_MODELHANDLER_INPUT1_MLP_MODELHANDLER_NO_FEATURE_H_
...
class Input1MLPModelNoFeatureHandler
{
public:
    Input1MLPModelNoFeature *mlp_model ;

    static const std::string OutputDelimiter ;

    Input1MLPModelNoFeatureHandler();
    virtual ~Input1MLPModelNoFeatureHandler();
...
template <typename MLPModel>
const std::string Input1MLPModelNoFeatureHandler<MLPModel>::OutputDelimiter = "\t";

template <typename MLPModel>
Input1MLPModelNoFeatureHandler<MLPModel>::Input1MLPModelNoFeatureHandler()
    ...
    std::vector<IndexSeq> &postag_seqs)
{
    ...
    read_annotated_data(is, training_sents, context_feature_gp_seqs, postag_seqs);
    ...
    std::vector<IndexSeq> &postag_seqs)
{
    ...
    read_annotated_data(is, devel_sents, context_feature_gp_seqs, postag_seqs);
...
template <typename MLPModel>
void Input1MLPModelNoFeatureHandler<MLPModel>::build_model()
{
...
template <typename MLPModel>
void Input1MLPModelNoFeatureHandler<MLPModel>::predict(std::istream &is, std::ostream &os)
{
...
template <typename MLPModel>
void Input1MLPModelNoFeatureHandler<MLPModel>::load_model(std::istream &is)
{
