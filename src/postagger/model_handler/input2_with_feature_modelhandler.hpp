...
{
public:
    Input2WithFeatureModel<RNNDerived> *sim;
...
template<typename RNNDerived, typename SIModel>
const size_t Input2WithFeatureModelHandler<RNNDerived, SIModel>::MaxSentNum;

template <typename RNNDerived, typename SIModel>
const std::string Input2WithFeatureModelHandler<RNNDerived, SIModel>::OutputDelimiter = "\t";

template <typename RNNDerived, typename SIModel>
Input2WithFeatureModelHandler<RNNDerived, SIModel>::Input2WithFeatureModelHandler()
    :sim(new SIModel())
{}
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::read_annotated_data(std::istream &is,
    std::vector<IndexSeq> &sents,
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::read_training_data(std::istream &is,
    std::vector<IndexSeq> &training_sents,
    std::vector<POSFeature::POSFeatureIndexGroupSeq> &features_gp_seqs,
    std::vector<IndexSeq> &postag_seqs)
{
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::read_devel_data(std::istream &is,
    std::vector<IndexSeq> &devel_sents,
    std::vector<POSFeature::POSFeatureIndexGroupSeq> &features_gp_seqs,
    std::vector<IndexSeq> &postag_seqs)
{
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::read_test_data(std::istream &is,
    std::vector<Seq> &raw_sents,
    std::vector<IndexSeq> &sents,
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::build_model()
{
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::train(const std::vector<IndexSeq> *p_sents,
    const std::vector<POSFeature::POSFeatureIndexGroupSeq> *p_feature_gp_seqs,
    const std::vector<IndexSeq> *p_tag_seqs,
    unsigned max_epoch,
    const std::vector<IndexSeq> *p_dev_sents,
...
template <typename RNNDerived, typename SIModel>
float Input2WithFeatureModelHandler<RNNDerived, SIModel>::devel(const std::vector<IndexSeq> *p_sents,
    const std::vector<POSFeature::POSFeatureIndexGroupSeq> *p_feature_gp_seqs,
    const std::vector<IndexSeq> *p_tag_seqs)
{
    unsigned nr_samples = p_sents->size();
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::predict(std::istream &is, std::ostream &os)
{
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::save_model(std::ostream &os)
{
...
template <typename RNNDerived, typename SIModel>
void Input2WithFeatureModelHandler<RNNDerived, SIModel>::load_model(std::istream &is)
{
