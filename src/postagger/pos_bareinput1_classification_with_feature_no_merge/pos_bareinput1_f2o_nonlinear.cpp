...
#include "pos_bareinput1_f2o_nonlinear_model.h"
...
static const string ProgramHeader = "Postagger BareInput1-Classification F2O Nonlinear Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    op_des.add_options()
        ...
        ("pos_feature_hidden_layer_dim", po::value<unsigned>()->default_value(50), "The dimension for postag feature hidden layer")
        ("pos_feature_hidden_layer_nonlinear_func", po::value<string>()->default_value("rectify"), "The nonlinear function for postag hidden layer"
          "'rectify'/'tanh' is available"
        )
    ...
    SingleInputWithFeatureModelHandler<RNNDerived, POSBareInput1ClassificationF2ONonlinearModel<RNNDerived>> model_handler;
