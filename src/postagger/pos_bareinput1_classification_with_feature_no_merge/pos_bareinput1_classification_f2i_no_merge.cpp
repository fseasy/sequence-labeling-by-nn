...
#include "pos_bareinput1_classification_f2i_no_merge_model.h"
...
static const string ProgramHeader = "Postagger BareInput1-Classification F2I No Merge Procedure based on DyNet Library";
...
int train_process(int argc, char *argv[], const string &program_name)
{
    ...
    SingleInputWithFeatureModelHandler<RNNDerived, POSBareInput1ClassificationF2IModel<RNNDerived>> model_handler;
